 ...
 class TechnicalSkills extends Component {
    render() {
        return (
            ...
            <h1 className="text-center font-details-b pb-4">THECHNOLOGY PROFICIENCIES</h1>
            <CardDeck>
              <Row className="d-flex justify-content-around">
                ...
                <Col md={4}>
                  <Card className="focus mt-2 mb-2">
                    <Card.Body>
                      <Card.Title className="text-center  card-title"><Image src={MicsoftLogo} alt="Logo" rounded className="image-style m-1"></Image> Technologies</Card.Title>
                      <hr />
                      <Card.Text className="card-text d-flex justify-content-start flex-column">
